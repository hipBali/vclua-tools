...
function inflate_band(x,y) return x & y end
function inflate_rshift(x,y) return x >> y end

local unpack = table.unpack or unpack
local loadstring = loadstring or load

function inflate_bitstream_init(file)
  local bs = {
...
-- Install loader
table.insert(package.searchers, 2, lar_loader) 
